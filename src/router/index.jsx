...
import {
    AboutPage, AdminContactMessageDetailsPage, AdminContactMessagesPage, AdminDashboard,
    AdminNewVehiclePage,AdminReservationDetailsPage,AdminReservationsPage,AdminUserDetailsPage,
    AdminUsersPage,AdminVehicleDetailsPage,AdminVehiclesPage,ContactPage,ErrorPage,
    HomePage, LoginPage, PrivacyPolicyPage,RegisterPage,UserProfilePage,UserReservationDetailsPage,
    UserReservationsPage, VehicleDetailsPage, VehiclesPage,
} from "../pages";
